...
export class CreatePedidoproductoTable1732321150258 implements MigrationInterface {
    name = 'CreatePedidoproductoTable1732321150258'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clientes" ("id" SERIAL NOT NULL, "dni" character varying NOT NULL, "nombre_completo" character varying NOT NULL, "telefono" character varying NOT NULL, CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`);
